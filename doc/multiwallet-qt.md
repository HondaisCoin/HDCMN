...
In order to support loading of multiple wallets in hondaiscoinmn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hondaiscoinmn.cpp.
...
Changes to hondaiscoinmn.cpp
----------------------
hondaiscoinmn.cpp is the entry point into hondaiscoinmn-qt, and as such, will require some minor modifications to provide hooks for
