...
#ifndef HondaisCoinMN_ZHDCMNTRACKER_H
#define HondaisCoinMN_ZHDCMNTRACKER_H
...
public:
    CzHDCMNTracker(std::string strWalletFile);
    ~CzHDCMNTracker();
...
#endif //HondaisCoinMN_ZHDCMNTRACKER_H
