...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HondaisCoinMN Core hondaiscoinmn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hondaiscoinmn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hondaiscoinmn transaction") + "\n" +
                               "  hondaiscoinmn-tx [options] -create [commands]   " + _("Create hex-encoded hondaiscoinmn transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hondaiscoinmn transaction
