                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HondaisCoinMN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HondaisCoinMN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hondaiscoinmn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHDCMN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HondaisCoinMN Core"), this);
    aboutAction->setStatusTip(tr("Show information about HondaisCoinMN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HondaisCoinMN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HondaisCoinMN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HondaisCoinMN addresses"));
    ...
    openAction->setStatusTip(tr("Open a HondaisCoinMN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HondaisCoinMN Core help message to get a list with possible HondaisCoinMN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("HondaisCoinMN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HondaisCoinMN network", "", count));
}
...
{
    QString strTitle = tr("HondaisCoinMN Core"); // default title
