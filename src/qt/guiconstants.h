...
/* HondaisCoinMN GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "HondaisCoinMN"
#define QAPP_ORG_DOMAIN "hondaiscoinmn.org"
#define QAPP_APP_NAME_DEFAULT "HondaisCoinMN-Qt"
#define QAPP_APP_NAME_TESTNET "HondaisCoinMN-Qt-testnet"
