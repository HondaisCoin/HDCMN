                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzHDCMNPathCustom = GetArg("-zhdcmnbackuppath", "");
    ...
    if(!strzHDCMNPathCustom.empty()) {
        ui->wallet_customzhdcmnbackuppath->setText(QString::fromStdString(strzHDCMNPathCustom));
        ui->wallet_customzhdcmnbackuppath_label->setVisible(true);
        ui->wallet_customzhdcmnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzHDCMNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the HondaisCoinMN RPC console.") + "<br>" +
