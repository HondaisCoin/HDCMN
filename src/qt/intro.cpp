...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HondaisCoinMN Core"),
     ...
     * override -datadir in the hondaiscoinmn.conf file in the default data directory
     * (to be consistent with hondaiscoinmnd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
