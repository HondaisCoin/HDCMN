...
/** Utility functions used by the HondaisCoinMN Qt UI.
 */
namespace GUIUtil
{
...
// Render HondaisCoinMN addresses in monospace font
...
// Parse "hondaiscoinmn:" URI into recipient object, return true on successful parsing
