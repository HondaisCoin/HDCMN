...
#ifndef HondaisCoinMN_ZHDCMNWALLET_H
#define HondaisCoinMN_ZHDCMNWALLET_H
...
public:
    CzHDCMNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHDCMN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHDCMN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //HondaisCoinMN_ZHDCMNWALLET_H
