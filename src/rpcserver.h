...
/**
 * HondaisCoinMN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzhdcmnseed(const UniValue& params, bool fHelp);
extern UniValue getzhdcmnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzhdcmn(const UniValue& params, bool fHelp);
extern UniValue dzhdcmnstate(const UniValue& params, bool fHelp);
