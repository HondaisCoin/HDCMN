Contributing to HondaisCoinMN Core
============================

The HondaisCoinMN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the HondaisCoinMN Core project, and is not to be
confused with overall HondaisCoinMN Network Protocol consensus changes.

Whether a pull request is merged into HondaisCoinMN Core rests with the project merge
...
Patches that change HondaisCoinMN consensus rules are considerably more involved than
...
Where a patch set proposes to change the HondaisCoinMN consensus, it must have been
...
The project leader is the release manager for each HondaisCoinMN Core release.
