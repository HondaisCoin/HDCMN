...
#   c) node1 mines 32 blocks, so now node 0 has 60001hdcmn, node 1 has 4250hdcmn, node2 has none.
#   d) node0 sends 601 hdcmn to node2, in two transactions (301 hdcmn, then 300 hdcmn).
